...
<head>
    ...
    <title>Login</title> 
    <link rel="stylesheet" href="../../web-design/css/login.css"> 
</head>
<body>
    ...
    <main>
        <div class="formStyle">
            ...
            <form action="../../auth/config/cLogin.php" name="loginForm" onsubmit="return validateLoginForm()" method="post"> 
    ...
    <script src="../../web-design/js/login.js"></script> 
</body>
</html>
