...
<head>
    ...
    <link rel="stylesheet" href="../../web-design/css/register.css"> 
</head>
<body>
    ...
    <main>
        <div class="formStyle">
            ...
            <form action="../../auth/config/cRegister.php" name="myForm" onsubmit="return validateFormRegister()" method="post"> 
    ...
    <script src="../../web-design/js/register.js"></script> 
</html>
